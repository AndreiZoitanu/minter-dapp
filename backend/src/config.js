...
const extraMetadata = {
  external_url: "https://boundincode.com", // Replace with your website or remove this line if you do not have one.
};
...
const ROYALTY_ADDRESS = "0x55fbCCBa8Dc41B5251453ffaD9625D35f9a1b550"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0x55fbCCBa8Dc41B5251453ffaD9625D35f9a1b550"]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Amazing collection of nothing"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafybeifxelkr54e6iec3hlid5p4ut3btll3dzgo2hbpcqjnkcogkdeckkm"; // Replace with your generic image that will display for all NFTs pre-reveal.
